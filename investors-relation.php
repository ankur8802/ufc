 ...
 <div class="about-us-title mg-t-10">
 	<div class="row mg-0">
 		<div class="col-md-12 pd-l-r-24">
 			...
 			<p class="fz-12 color-gray inline"> Investor Relations <span class="color-gray fz-10"> > </span></p>
 			<p class="fz-16 inline color-black font-bold">  Financial Results </p>
 			</div>
 			</div>
 		</div>
 	</div>
 		...
 		<li class="mobile-menu-about-us-text"> Chairman's Message
 		 <i class="fas fa-angle-down rotate-180 fz-18" style="float:right;"></i>
         	...
         	<ul class="mg-0 pd-0 mobile-menu-about-us-text-start" style="display:none;">
         		...
         		<li> <a href="board.php"> Meetings </a> </li>
         		<li> <a href="#"> Corporate Governance </a>  </li>
 	         	<li> <a href="#">Stackholders Feedback Forms </a>  </li>
...
<div class="container-fluid pd-l-r-24 mg-t-10">
	<div class="row mg-0 click-el">
		<div class="col-lg-2 desktop-version pd-0 br-l-about-us-col-lg-2">
			<div class="row">
				<div class="col-md-12">
			<p class="fz-12 color-white pd-5 p92 mg-0">INVESTOR RELATION</p>
			</div>
			</div>
			<div class="row">
				<div class="col-md-12">
			<p class="color-gray font-bold mg-t-b-10-0 fz-12 pd-10 p92-active mib4-hide mib4-first-menu">Financial Results  </p>
			<p class="color-gray pd-10 fz-12 mg-0 mib4-hide mib4-second-menu">Meetings</p>
			<p class="color-gray pd-10 fz-12 mg-0 mib4-hide mib4-third-menu">Corporate Governance </p>
			<p class="color-gray pd-10 fz-12 mg-0 mib4-hide mib4-fourth-menu">Stackholders Feedback Forms</p>
		...
		<div class="col-lg-10 col-md-12 col-sm-12 mib4 mib4-first">
 		...
 		<div class="row">
 			<div class="col-md-4 pd-20 pd-b-0">
 				<div class="ser-img">
 				<img src="assets/images/services-info.jpg" alt="" width="100%">
 				</div>
 			</div>
 			<div class="col-md-8 pd-20 pd-l-0 pd-b-0 pd-t-10">
 				    <h5 class="fz-17"> Financial Results Data</h5>
